...
form.logF input[type=password]`)
    ...
    .blur(function () {
        ...
        // 2. 현재 블러가 발생한 요소의 값은?
        // 이름 입력창(id=='mnm')이면 trim() 나머지는 groSpace()로 처리하여 공백을 제거한다.
    ...
    ******************************************************/
        ...
        ******************************************************/
            ...
            if(!vReg(cv, cid)){
                ...
                // 2. 만약 DB 조회하여 같은 아이디가 없다면 '멋진 아이디네요~!'와 같은 
                // 메시지 출력 여기서 우선은 DB 조회 못하므로 통과시 메시지로 출력
                // 메시지 띄우기
        ...
        ******************************************************/
            ...
            // console.log("비밀번호 검사결과 : ", vReg(cv, mpw));
            if(!vReg(cv, mpw)){
