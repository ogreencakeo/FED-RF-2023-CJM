...
// 대상 : .intro-mv-img
// 이벤트 : click
// -> 가상요소 플레이 버튼 클릭시 이벤트 버블링으로 본 박스가 반응함!
// 1. 대상 선정하기
...
clipData.forEach(val => {
    clipCode += `
        <li>
            <iframe width="1280" height="720" src="https://www.youtube.com/embed/${val.mvid}"></iframe>
            <h4>${val.subtit}</h4>
            <h3>${val.title}</h3>
        </li>
    `;
});
// console.log('clipCode :', clipCode);
