...
/****************************************************************************
    ...
    할 경우 this키워드로 생성자함수 멤버 등록하여 사용함
    -> 인스턴스 코딩구역에서 생성된 인스턴스를 변수에 담아 하위 속성 / 메서드로
    호출이 가능해진다.
    4. 유의사항 : 생성자함수 내부에서 this 키워드로 등록된 속성 / 메서드는 내부에서
    호출시에도 반드시 this 키워드를 사용하여 호출해야 함 (안쓰면 에러)
****************************************************************************/
