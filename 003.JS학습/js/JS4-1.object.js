// 영화 초이스 객체 ///// object.js
// 자신만의 오브젝트! -> 변경하능하게 let으로!!!
const cake_choi = {};
// 오브젝트 형만 만들고 객체내용은 아래에서!
// 1. 영화제목
cake_choi.title = '암살';
// 2. 감독
cake_choi.director = '최동훈';
// 3. 배우
cake_choi.actor = '전지현, 이정재, 하정우, 최덕문, 조진웅';
// 4. 장르
cake_choi.genre = '액션/드라마';
// 5. 관람가
cake_choi.ratings = '15세 관람가';

// 6. 예고편
cake_choi.trailer = function(){
