...
// 만약 전달값 porps가 없으면 없는 상태가 계속 유지되므로
// 재활용 없이 다시 컴포넌트가 그려지는 일은 없다. -> 중복실행하지 않는다.
        ...
        <React.Fragment>
            <div id="footer-area">
                <footer className="footer-area ibx common-area">
                    ...
                    <div className="blogo">
                        {/* 전달상태값에 따라 이미지변경함! */}
                        <img src={props.fsts==0? 
                                    "./images/footer_logo.png" 
                                    : "https://media.tenor.com/roL8BtIs724AAAAd/vogue-celine-vogue.gif"} alt="하단로고" />
                    </div>
                    {/* 3-2.회사주소 */}
